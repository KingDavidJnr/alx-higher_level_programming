...
In this networking project, We utilised `curl` in Bash scripts to send various types
of HTTP headers. In the process, We learnt about how URLs work, domain names,
